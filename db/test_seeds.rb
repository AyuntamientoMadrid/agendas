...
# Attachments
Attachment.create(title: 'pdf', file: File.open('./spec/fixtures/dummy.pdf'), event: registration_offices)
Attachment.create(title: 'jpg', file: File.open('./spec/fixtures/dummy.jpg'), event: registration_offices)
