  ...
  describe "when is in default mode" do
    ...
    describe "#organization_to_row" do
      it "Should return array of public organization columns in exact order" do
        ...
        expect(row[25]).to eq(I18n.l(organization.inscription_date, format: :short))
        ...
        expect(row[32]).to eq(I18n.l(organization.updated_at, format: :short))
        expect(row[33]).to eq(nil)
  ...
  describe "when is in extended mode" do
    ...
    describe "#organization_to_row" do
      it "Should return array of columns in exact order" do
        ...
        expect(row[26]).to eq(I18n.l(organization.inscription_date, format: :short))
        ...
        expect(row[39]).to eq(I18n.l(organization.updated_at, format: :short))
        expect(row[40]).to eq(nil)
